export class ITetromino {
    ...
    combineMatrix(matrix1) {
        ...
        if (this.rotation === 'up') {
            matrix[this.step][0 + this.shift] = 'i';
            matrix[this.step][1 + this.shift] = 'i';
            matrix[this.step][2 + this.shift] = 'i';
            matrix[this.step][3 + this.shift] = 'i';
        }
        else if (this.rotation === 'right') {
            matrix[this.step - 1][2 + this.shift] = 'i';
            matrix[this.step][2 + this.shift] = 'i';
            matrix[this.step + 1][2 + this.shift] = 'i';
            matrix[this.step + 2][2 + this.shift] = 'i';
        }
        else if (this.rotation === 'down') {
            matrix[this.step + 1][0 + this.shift] = 'i';
            matrix[this.step + 1][1 + this.shift] = 'i';
            matrix[this.step + 1][2 + this.shift] = 'i';
            matrix[this.step + 1][3 + this.shift] = 'i';
        }
        else if (this.rotation === 'left') {
            matrix[this.step - 1][1 + this.shift] = 'i';
            matrix[this.step][1 + this.shift] = 'i';
            matrix[this.step + 1][1 + this.shift] = 'i';
            matrix[this.step + 2][1 + this.shift] = 'i';
        }
