export class STetromino {
    ...
    combineMatrix(matrix1) {
        ...
        if (this.rotation === 'up') {
            matrix[this.step + 1][0 + this.shift] = 's';
            matrix[this.step + 1][1 + this.shift] = 's';
            matrix[this.step][1 + this.shift] = 's';
            matrix[this.step][2 + this.shift] = 's';
        }
        else if (this.rotation === 'right') {
            matrix[this.step - 1][1  + this.shift] = 's';
            matrix[this.step + 0][1 + this.shift] = 's';
            matrix[this.step + 0][2 + this.shift] = 's';
            matrix[this.step + 1][2 + this.shift] = 's';
        }
            ...
            matrix[this.step - 1][0  + this.shift] = 's';
            matrix[this.step + 0][0 + this.shift] = 's';
            matrix[this.step + 0][1 + this.shift] = 's';
            matrix[this.step + 1][1 + this.shift] = 's';
        }
